...
function onIncomingEmoticon(message) {
  ...
  if (isValid) {
    ...
    if(EMOTICONS[index] == "happy"){
      document.getElementById('td1').innerHTML = "Kate";
    }
    else if(EMOTICONS[index] == "fantastic"){
      document.getElementById('td1').innerHTML = "Tom";
    }
    else if(EMOTICONS[index] == "sad"){
      document.getElementById('td1').innerHTML = "Jhon";
    }
    else if(EMOTICONS[index] == "angry"){
      document.getElementById('td1').innerHTML = "Sam";
    }
