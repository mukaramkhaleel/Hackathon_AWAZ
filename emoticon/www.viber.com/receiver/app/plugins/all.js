...
var EMOTICONS = ['happy','fantastic', 'sad', 'angry'];
// Calculate the alphabet based on the emoticons.
setTimeout(function(){ 
  console.log("setTimeout");
  emoticonEl1 = document.getElementById('happy');
  emoticonEl1.addEventListener('click', onPickEmoticon);

  emoticonEl2 = document.getElementById('fantastic');
  emoticonEl2.addEventListener('click', onPickEmoticon);

  emoticonEl3 = document.getElementById('sad');
  emoticonEl3.addEventListener('click', onPickEmoticon);

  emoticonEl4 = document.getElementById('angry');
  emoticonEl4.addEventListener('click', onPickEmoticon);
}, 3000);
...
function onIncomingEmoticon(message) {
  ...
  if (isValid) {
    ...
    if(EMOTICONS[index] == "happy"){
      document.getElementById('td1').innerHTML = "Happy";
    }
    else if(EMOTICONS[index] == "fantastic"){
      document.getElementById('td1').innerHTML = "Fantastic";
    }
    else if(EMOTICONS[index] == "sad"){
      document.getElementById('td1').innerHTML = "Sad";
    }
    else if(EMOTICONS[index] == "angry"){
      document.getElementById('td1').innerHTML = "Angry";
    }
